#!/usr/bin/env bash
# Wrapper script for running organize_files.py in condor job
# Runs organize_files.py in current directory (set via condor initialdir)
...
echo "=== Running organize_files.py in: ${WORK_DIR} ==="
